...
tools: Glob, Grep, LS, Read, NotebookRead, WebFetch, TodoWrite, WebSearch, ListMcpResourcesTool, ReadMcpResourceTool, mcp__github__list_pull_requests, mcp__github__list_issues, mcp__github__search_issues
model: sonnet
color: red
---
